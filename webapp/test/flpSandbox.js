		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#idrstrevsersestring-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"idrstrevsersestring-display": {
								"semanticObject": "idrstrevsersestring",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=idrst.revsersestring",
									"url": sap.ui.require.toUrl("idrst/revsersestring")
								}
							}
						}
					}
